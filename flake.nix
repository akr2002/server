{
  ...
  let
    ...
    CPATH = builtins.concatStringsSep ":" [
      (pkgs.lib.makeSearchPathOutput "dev" "include" [pkgs.llvmPackages_20.libcxx])
      (pkgs.lib.makeSearchPath "resource-root/include" [pkgs.llvmPackages_20.clang])
    ];
  in {
      packages.x86_64-linux.default = pkgs.llvmPackages_20.libcxxStdenv.mkDerivation {
        pname = "server";
        version = "0.1.0";
        src = ./.;
